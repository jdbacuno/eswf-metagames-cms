...
<body class="bg-surface text-text font-sans">
  ...
  <main class="max-w-3xl mx-auto mt-8 px-6 pb-16">
    ...
    <!-- CTA (main title) -->
    <p class="text-[0.7rem] font-bold tracking-widest uppercase text-muted mt-8 mb-3">Main title</p>
    <div class="bg-surface-card border border-border rounded-xl px-6 py-5 mb-4" id="card-cta">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-base font-semibold">Welcome line</h2>
        <span class="text-[0.7rem] font-bold tracking-wide px-2.5 py-0.5 rounded-full
                     bg-badge-blue-bg text-badge-blue-fg border border-accent">Read / Update</span>
      </div>
      <div class="skeleton"></div>
    ...
    <div class="bg-surface-card border border-border rounded-xl px-6 py-5 mb-4" id="card-catchphrase">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-base font-semibold">Tagline &amp; paragraph</h2>
        <span class="text-[0.7rem] font-bold tracking-wide px-2.5 py-0.5 rounded-full
                     bg-badge-blue-bg text-badge-blue-fg border border-accent">Read / Update</span>
      </div>
      <div class="skeleton"></div>
    ...
    <!-- CARDS -->
    <p class="text-[0.7rem] font-bold tracking-widest uppercase text-muted mt-8 mb-3">Feature cards</p>
    <div class="bg-surface-card border border-border rounded-xl px-6 py-5 mb-4" id="card-cards">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-base font-semibold">Feature cards</h2>
        <span class="text-[0.7rem] font-bold tracking-wide px-2.5 py-0.5 rounded-full
