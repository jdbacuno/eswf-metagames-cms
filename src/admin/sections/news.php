...
<head>
  <meta charset="UTF-8">
  <title>Edit News &amp; Updates — MetaGames CMS</title>
...
<body class="bg-surface text-text font-sans">
  ...
  <main class="max-w-3xl mx-auto mt-8 px-6 pb-16">
    <h1 class="text-2xl font-semibold">Edit: News &amp; Updates</h1>
    ...
    <p class="text-[0.7rem] font-bold tracking-widest uppercase text-muted mt-8 mb-3">Image</p>
    <div class="bg-surface-card border border-border rounded-xl px-6 py-5 mb-4" id="card-image">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-base font-semibold">Featured image</h2>
        <span class="text-[0.7rem] font-bold tracking-wide px-2.5 py-0.5 rounded-full
                     bg-badge-blue-bg text-badge-blue-fg border border-accent">Read / Update</span>
      </div>
      <div class="skeleton"></div>
